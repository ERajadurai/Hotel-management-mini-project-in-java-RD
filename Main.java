...
class holder implements Serializable{
    ...
    Singleroom luxury_singlerrom[]=new Singleroom[10];
    Singleroom deluxe_singlerrom[]=new Singleroom[20];
}
...
class Hotel{
    ...
    static void CustDetails(int i,int rn){
        ...
        switch (i) {
            ...
            case 2:hotel_ob.deluxe_doublerrom[rn]=new Doubleroom(name,contact,gender,name2,contact2,gender2);
                break;
            case 3:hotel_ob.luxury_singlerrom[rn]=new Singleroom(name,contact,gender);
                break;
            case 4:hotel_ob.deluxe_singlerrom[rn]=new Singleroom(name,contact,gender);
                break;
    ...
    static void bookroom(int i){
        ...
        switch(i){
            ...
            case 2:
                ...
                break;
            case 3:
                for(j=0;j<hotel_ob.luxury_singlerrom.length;j++)
                {
                    if(hotel_ob.luxury_singlerrom[j]==null)
                    {
                ...
                try{
                    rn=sc.nextInt();
                    rn=rn-31;
                    if(hotel_ob.luxury_singlerrom[rn]!=null)
                        throw new NotAvailable();
                    CustDetails(i,rn);
                }
                catch(Exception e)
                ...
                break;
            case 4:
                for(j=0;j<hotel_ob.deluxe_singlerrom.length;j++)
                {
                    if(hotel_ob.deluxe_singlerrom[j]==null)
                    {
                ...
                try{
                    rn=sc.nextInt();
                    rn=rn-41;
                    if(hotel_ob.deluxe_singlerrom[rn]!=null)
                        throw new NotAvailable();
                    CustDetails(i,rn);
                }
                catch(Exception e)
    ...
    static void bill(int rn,int rtype)
    {
        ...
        switch(rtype){
            ...
            case 3:amount+=2200;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb:hotel_ob.luxury_singlerrom[rn].food){
                    amount+=obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
                }
            ...
            case 4:amount+=1200;
                ...
                System.out.println("Item   Quantity    Price");
                System.out.println("-------------------------");
                for(Food obb: hotel_ob.deluxe_singlerrom[rn].food){
                    amount+=obb.price;
                    String format = "%-10s%-10s%-10s%n";
                    System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
                }
    ...
    static void deallocate(int rn,int rtype){
        ...
        switch (rtype){
            ...
            case 3:
                if(hotel_ob.luxury_singlerrom[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.luxury_singlerrom[rn].name);
                else{
                    System.out.println("Empty Already");
                    return;
                }
                ...
                if(w=='y'||w=='Y'){
                    bill(rn,rtype);
                    hotel_ob.luxury_singlerrom[rn]=null;
                    System.out.println("Deallocated succesfully");
                }
            ...
            case 4:
                if(hotel_ob.deluxe_singlerrom[rn]!=null)
                    System.out.println("Room used by "+hotel_ob.deluxe_singlerrom[rn].name);
                else{
                    System.out.println("Empty Already");
                    return;
                }
                ...
                if(w=='y'||w=='Y'){
                    bill(rn,rtype);
                    hotel_ob.deluxe_singlerrom[rn]=null;
                    System.out.println("Deallocated succesfully");
                }
                break;
            default:
            ...
            do{
                ...
                switch(rtype){
                    ...
                    case 2: hotel_ob.deluxe_doublerrom[rn].food.add(new Food(i,q));
                        break;
                    case 3: hotel_ob.luxury_singlerrom[rn].food.add(new Food(i,q));
                        break;
                    case 4: hotel_ob.deluxe_singlerrom[rn].food.add(new Food(i,q));
                        break;
                }
